...
//      
//        let url = Bundle.main.url(forResource: "彼得后书", withExtension: "txt")
//        
...
class DZMMainController: DZMViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private func setupCollectionView() {
        ...
        collectionView.register(UINib.init(nibName: "DZMMainCellCell", bundle: nil), forCellWithReuseIdentifier: "DZMMainCellCell")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DZMMainCellCell", for: indexPath) as! DZMMainCellCell
        let model = models[indexPath.item]
        cell.shortNameLabel.text = model.ShortName
        cell.titleLabel.text = model.FullName
        cell.countNum.text = "\(model.ChapterNumber)"
        return cell
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let url = model.getPath() else {
            return
        }
